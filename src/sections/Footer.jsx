  ...
  return (
    <footer className="bg-main-colour text-white py-12">
      <MaxWidthContainer>
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <div className="mt-2">
              ...
              />
              <button className="bg-blue-600 text-white mt-2 px-4 py-2 rounded-lg hover:bg-blue-700 transition">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="mt-8 border-t border-blue-700 pt-6 flex justify-between items-center text-sm max-w-6xl mx-auto px-4">
