      ...
      <MaxWidthContainer>
        <div className="flex flex-col items-center justify-center text-center relative">
          ...
          <div className="flex flex-wrap justify-center space-x-0 md:space-x-10  space-y-4 md:space-y-0 mt-8">
            {/* Button 1 */}
            <div className="bg-main-colour text-white px-6 py-3 h-16 text-2xl rounded-xl flex items-center space-x-2">
            ...
            {/* Button 2 */}
            <div className="bg-blue-300 text-blue-800 px-6 py-3 h-16 text-2xl rounded-xl flex items-center space-x-2">
              <span>Book an Appointment</span>
              <img
                src="/icons/team2.png"
                alt="People Icon"
